...
const activeCircle = "flex items-center justify-center w-5 h-5 rounded-full";
const ThemeSwitcher = () => {
    ...
    return (
        <div className="bg-gray-800 h-8 w-14 justify-around items-center flex rounded-full">
            <button className={`${activeCircle} ${theme === "light" ? "bg-gray-100" : ""}`}
            ...
            <button className={`${activeCircle} ${theme === "dark" ? "bg-gray-100" : ""}`}
